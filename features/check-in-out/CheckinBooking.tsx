      ...
      {!hasBreakfast && (
        <div className="bg-white border border-gray-100 dark:b order-gray-800 rounded-md py-5 px-8">
          <Checkbox
            ...
            id="breakfast"
          >
            {t('wannaAddBreakfast')} {formatCurrency(optionalBreakfastPrice, t2)}?
          </Checkbox>
        </div>
      )}
      ...
      <div className="bg-white dark:bg-black  border border-gray-100 dark:border-gray-800 dark:text-gray-300 rounded-md py-5 px-8">
        ...
        >
          ...
          {!addBreakfast
            ...
            : `${formatCurrency(
                totalPrice + optionalBreakfastPrice, t2
              )} (${formatCurrency(totalPrice, t2)} + ${formatCurrency(
                optionalBreakfastPrice, t2
              )})`}
        </Checkbox>
      </div>
